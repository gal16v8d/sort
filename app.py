...
OPTIONS = ['BubbleSort', 'HeapSort', 'RadixSort', 'BinSort', 'ShellSort', 'QuickSort']
...
add_button=Button(frame2,text="Add", width="10", height="1", command=add_value)
add_button.grid(row=0, column=0, padx=10, pady=10)
clear_last_button=Button(frame2,text="Clear last", width="10", height="1", command=clear_last_value)
clear_last_button.grid(row=0, column=1, padx=10, pady=10)
clear_all_button=Button(frame2,text="Clear all", width="10", height="1", command=clear_fields)
clear_all_button.grid(row=0, column=2, padx=10, pady=10)
sort_button=Button(frame2,text="Sort", width="10", height="1", command=sort_data)
